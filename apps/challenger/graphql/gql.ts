 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    mutation CreateUserSubmission($submission: SubmissionInput!) {\n        createUserSubmission(submission: $submission ){\n              submission {\n                  id\n                  runtime\n                  score\n                  status\n                  createdAt\n                  updatedAt\n              }\n              inputResults {\n                  testCase {\n                      id\n                  }\n                  output\n                  executionTime\n                  timeFormat\n              }\n          }\n      }\n  "): typeof import('./graphql').CreateUserSubmissionDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n    mutation UpdateUserSubmission($submissionId: String!, $submission: SubmissionInput!) {\n        updateUserSubmission(submissionId: $submissionId, submission: $submission ){\n              submission {\n                  id\n                  runtime\n                  score\n                  status\n                  createdAt\n                  updatedAt\n              }\n              inputResults {\n                  testCase {\n                      id\n                  }\n                  output\n                  executionTime\n                  timeFormat\n              }\n          }\n      }\n  "): typeof import('./graphql').UpdateUserSubmissionDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
