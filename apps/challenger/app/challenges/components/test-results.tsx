      ...
      {testResults.map((test, index) => (
        ...
        >
          <CardContent className="p-0">
            <Button
              variant="ghost"
              className="w-full flex items-center justify-between p-4 hover:bg-secondary transition-colors duration-200 group"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-sm group-hover:text-primary transition-colors duration-200">
            ...
            <AnimatePresence>
              {expandedTests[index] && (
                ...
                >
                  {test.isSecret ? (
                    <div className="font-mono p-4 text-center text-muted-foreground">
